...
urlpatterns = patterns('',  # nopep8
    ...
    url(r'^generate_certificate_single$',
        'instructor.views.api.generate_certificate_single', name="generate_certificate_single"),
    url(r'^generate_certificate_all$',
        'instructor.views.api.generate_certificate_all', name="generate_certificate_all"),    
